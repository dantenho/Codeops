...
- If `requirements.md` is missing, STOP and ask the user to create requirements first.
- If research fails or is inconclusive, state clearly what is unknown and ask for user guidance.
- If the user's change request contradicts the requirements, highlight the conflict and ask for resolution.
